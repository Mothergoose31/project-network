...
const Mentor = ({ }) => {
  ...
  const { contractAddresss, mentorAddress, uiLblTotalEth, uiLblDisbursedEth } = useContext(GlobalContext)
  const { deployFreelancer, projectState, btnEndProject, btnRefresh, btnAddSchedule, getContractAddress, onShortcode, onDescription, onValue, btnGo} = useContext(GlobalContext)
