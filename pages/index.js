...
const Home = ({ account, decentee, loading }) => {
  return (
    ...
    {loading ? <SplashPage/>
          ...
          <main className={styles.main}>
              ...
              <div className={styles.Image}>
                <a href="https://nextjs.org">
                  <svg width="275.41368078175896" height="93.43552299085779" viewBox="0 0 275.41368078175896 93.43552299085779" className="css-1j8o68f">
                    <defs id="SvgjsDefs2126">
                      <linearGradient id="SvgjsLinearGradient2129">
                        <stop id="SvgjsStop2130" stop-color="#8f5e25" offset="0"></stop>
                        <stop id="SvgjsStop2131" stop-color="#fbf4a1" offset="0.5"></stop>
                        <stop id="SvgjsStop2132" stop-color="#8f5e25" offset="1"></stop>
                      </linearGradient>
                    </defs>
                    <g id="SvgjsG2127" featurekey="1RRcwp-0" transform="matrix(4.386965906448481,0,0,4.386965906448481,-7.019146077878076,4.731075374759939)" fill="url(#SvgjsLinearGradient2129)">
        ...
        © 2021 Developed by Fuad Abdella and Joseph Alvarenga Beech
        <br></br>
