...
contract Decentee{
 ...
 string public name = "Decentee";
    ...
    address payable public decenteeAddress;
	...
	modifier onlyDecentee() {
		require(msg.sender == decenteeAddress);
		_;
	}
	...
	modifier bothClientDecentee(){
		require(msg.sender == clientAddress || msg.sender == decenteeAddress);
		_;	    
	}
    ...
    constructor()
    {
        decenteeAddress = payable(msg.sender);
    ...
    function releaseFunds(int256 _scheduleID)
        ...
        onlyDecentee
    {
        decenteeAddress.transfer(scheduleRegister[_scheduleID].value);
